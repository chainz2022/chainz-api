package es.eltrueno.protocol.tinyprotocol;
...
public final class Reflection {
    ...
    public static <T> T copy(T entity, Class<?>[] parameterTypes, Object[] params) throws IllegalAccessException, InstantiationException, NoSuchMethodException, InvocationTargetException {
        Class<?> clazz = entity.getClass();
        T newEntity = (T) entity.getClass().getConstructor(parameterTypes).newInstance(params);
        while (clazz != null) {
    ...
    public static Object getNativePlayer(Player player) throws Exception {
